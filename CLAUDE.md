...
- **Proposal-Driven Development** — ChatGPT designs (Proposal), Claude Code implements. See `interaction/proposal-driven-development.md`
...
**`AGENTS.md` is a near-verbatim copy of this file** — they differ only in the title and which agent is named as implementer. Any change to architecture here must be mirrored there in the same commit (see commit `ec10994`).

## Context Files

Agent 在开始工作前应按顺序读取：
1. `CLAUDE.md` — 本文件，项目整体架构和约定
...
interaction/           — AI Agent interaction methodology (ChatGPT ↔ Claude Code workflow)
```
